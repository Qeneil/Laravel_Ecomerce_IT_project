...
<head>
    ...
    <title>Add Category - DP Store</title>
...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-5">
            <h2 class="text-3xl font-bold mt-5">Add Category</h2>
            <div class="bg-white border border-gray-300 rounded-lg p-6 mt-3">
            <form action="{{ route('admin.category.store') }}" method="POST">
    @csrf
    <!-- ฟิลด์ฟอร์มต่างๆ เช่น ชื่อหมวดหมู่ -->
    <label for="categoryName" class="block text-lg font-semibold mb-2">Category Name</label>
    <input type="text" name="category_name" id="categoryName" class="border border-gray-300 rounded-lg p-2 w-full mb-4" placeholder="Enter category name" required>
    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg">Add Category</button>
</form>
